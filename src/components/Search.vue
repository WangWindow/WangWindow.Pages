...
onMounted(() => {
    const initializeSearch = () => {
        ...
        pagefindLoaded.value = typeof window !== "undefined" && !!(window as any).pagefind && typeof (window as any).pagefind.search === "function";
...
<template>
  ...
  ">
        ...
        <input :placeholder="i18n(I18nKey.search)" v-model="keywordDesktop"
            @focus="() => doSearch(keywordDesktop, true)" class="transition-all pl-10 text-sm bg-transparent outline-0
